...
public class AssignmentTest {
    ...
    /*Testing getSubmissionBefore Method when adding in no order*/
	@Test(timeout = 100)
	public void testGetBefore_SELF() {
		SubmissionHistory history = new Assignment();
		
		Submission Z = testHelperAdd(history, "cghy1678", new Date(300000), 10);
		Submission S = testHelperAdd(history, "cghy1678", new Date(1500000), 45);
		Submission R = testHelperAdd(history, "qwer1234", new Date(700000), 45);
		Submission T = testHelperAdd(history, "qwer1234", new Date(3000000), 89);
		Submission Y = testHelperAdd(history, "cghy1678", new Date(500000), 80);
		Submission A = testHelperAdd(history, "tyui7890", new Date(1900000), 78);
		Submission Q = testHelperAdd(history, "tyui7890", new Date(1300000), 78);
		Submission H = testHelperAdd(history, "qwer1234", new Date(900000), 34);
		Submission L = testHelperAdd(history, "tyui7890", new Date(1600000), 89);
		Submission O = testHelperAdd(history, "cghy1678", new Date(1100000), 56);
		
		testHelperEquals(Z, history.getSubmissionBefore("cghy1678", new Date(400000)));
		assertNull(history.getSubmissionBefore("cghy1678", new Date(200000)));

		testHelperEquals(R, history.getSubmissionBefore("qwer1234", new Date(800000)));
		assertNull(history.getSubmissionBefore("qwer1234", new Date(400000)));

		testHelperEquals(Q, history.getSubmissionBefore("tyui7890", new Date(1500000)));
		assertNull(history.getSubmissionBefore("tyui7890", new Date(700000)));

		testHelperEquals(S, history.getSubmissionBefore("cghy1678", new Date(1600000)));
		testHelperEquals(R, history.getSubmissionBefore("qwer1234", new Date(800000)));
	...
	/*getBestGrade method*/
	@Test(timeout = 100)
	public void testBestGrade_SELF() {
    SubmissionHistory history = new Assignment();
		
		testHelperAdd(history, "cccc2345", new Date(500000), 20);
		assertEquals(new Integer(20), history.getBestGrade("cccc2345"));
		assertNull(history.getBestGrade("dddd1111"));

		testHelperAdd(history, "cccc2345", new Date(2000000), 50);
		assertEquals(new Integer(50), history.getBestGrade("cccc2345"));
		assertNull(history.getBestGrade("dddd1111"));

		testHelperAdd(history, "dddd1111", new Date(600000), 78);
		assertEquals(new Integer(50), history.getBestGrade("cccc2345"));
		assertEquals(new Integer(78), history.getBestGrade("dddd1111"));

		testHelperAdd(history, "cccc2345", new Date(1000000), 20);
		assertEquals(new Integer(50), history.getBestGrade("cccc2345"));
		assertEquals(new Integer(78), history.getBestGrade("dddd1111"));

		testHelperAdd(history, "dddd1111", new Date(200000), 70);
		assertEquals(new Integer(50), history.getBestGrade("cccc2345"));
		assertEquals(new Integer(78), history.getBestGrade("dddd1111"));
	}
	
	/*getSubmissionFinal method*/
	@Test(timeout = 100)
	public void testGetFinal_SEFL() {
		SubmissionHistory history = new Assignment();
		
		Submission Q = testHelperAdd(history, "cccc2345", new Date(300000), 10);
		testHelperEquals(Q, history.getSubmissionFinal("cccc2345"));
		assertNull(history.getSubmissionFinal("dddd1111"));

		Submission J = testHelperAdd(history, "cccc2345", new Date(2000000), 45);
		testHelperEquals(J, history.getSubmissionFinal("cccc2345"));
		assertNull(history.getSubmissionFinal("dddd1111"));

		Submission C = testHelperAdd(history, "dddd1111", new Date(500000), 89);
		testHelperEquals(J, history.getSubmissionFinal("cccc2345"));
		testHelperEquals(C, history.getSubmissionFinal("dddd1111"));

		Submission D=testHelperAdd(history, "cccc2345", new Date(3000000), 68);
		testHelperEquals(D, history.getSubmissionFinal("cccc2345"));
		testHelperEquals(C, history.getSubmissionFinal("dddd1111"));

		testHelperAdd(history, "dddd1111", new Date(400000), 56);
		testHelperEquals(D, history.getSubmissionFinal("cccc2345"));
		testHelperEquals(C, history.getSubmissionFinal("dddd1111"));
	}
	...
	@Test(timeout = 100)
	public void testGetBestandRemove_SELF() {
		SubmissionHistory history = new Assignment();
		Submission Z = testHelperAdd(history, "cghy1678", new Date(300000), 10);
		Submission S = testHelperAdd(history, "cghy1678", new Date(1500000), 45);
		Submission R = testHelperAdd(history, "qwer1234", new Date(700000), 45);
		Submission T = testHelperAdd(history, "qwer1234", new Date(3000000), 89);
		Submission Y = testHelperAdd(history, "cghy1678", new Date(500000), 80);
		Submission A = testHelperAdd(history, "tyui7890", new Date(1100000), 78);
		Submission Q = testHelperAdd(history, "tyui7890", new Date(1300000), 78);
		
		assertEquals(new Integer(80), history.getBestGrade("cghy1678"));
		assertEquals(new Integer(78), history.getBestGrade("tyui7890"));

		history.remove(Z);
		assertEquals(new Integer(80), history.getBestGrade("cghy1678"));
		assertEquals(new Integer(89), history.getBestGrade("qwer1234"));

		history.remove(T);
		assertEquals(new Integer(45), history.getBestGrade("qwer1234"));

		history.remove(Q);
		assertEquals(new Integer(78), history.getBestGrade("tyui7890"));

		history.remove(Y);
		assertEquals(new Integer(45), history.getBestGrade("cghy1678"));
	}

	/*TESTING TOPstudents method*/
	@Test(timeout = 100)
	public void testTopStudents_SELF() {
		SubmissionHistory history = new Assignment();
		Submission A = testHelperAdd(history, "a", new Date(700000), 10);
		Submission B = testHelperAdd(history, "b", new Date(100000), 70);
		Submission C = testHelperAdd(history, "c", new Date(600000), 35);
		Submission D = testHelperAdd(history, "d", new Date(100000), 57);
		Submission E = testHelperAdd(history, "e", new Date(500000), 80);//best
		Submission F = testHelperAdd(history, "f", new Date(100000), 80); //best
		Submission G = testHelperAdd(history, "a", new Date(800000), 80);//best
		Submission H = testHelperAdd(history, "b", new Date(200000), 45);
		Submission J = testHelperAdd(history, "c", new Date(700000), 67);
		Submission K = testHelperAdd(history, "d", new Date(300000), 80); //best
		Submission L = testHelperAdd(history, "e", new Date(200000), 80); //best
		Submission M = testHelperAdd(history, "f", new Date(200000), 78);
		
		//top grade is 180
		List<String> studentsExpected = Arrays.asList("a","d","e","f");
		List<String> studentsActual = history.listTopStudents();
	...
	@Test(timeout = 100)
	public void testRegressions_SELF() {
		SubmissionHistory history = new Assignment();
		Submission A = testHelperAdd(history, "a", new Date(700000), 10);
		Submission B = testHelperAdd(history, "b", new Date(100000), 70);
		Submission C = testHelperAdd(history, "c", new Date(600000), 35);
		Submission D = testHelperAdd(history, "d", new Date(100000), 57);
		Submission E = testHelperAdd(history, "e", new Date(500000), 80);
		Submission F = testHelperAdd(history, "f", new Date(100000), 80);
		Submission G = testHelperAdd(history, "a", new Date(800000), 80);
		Submission H = testHelperAdd(history, "b", new Date(200000), 45);//regression
		Submission J = testHelperAdd(history, "c", new Date(700000), 67);
		Submission K = testHelperAdd(history, "d", new Date(300000), 80);
		Submission L = testHelperAdd(history, "e", new Date(200000), 68);
		Submission M = testHelperAdd(history, "f", new Date(200000), 78);//regression
		
		List<String> studentsExpected = Arrays.asList("b","f");
		List<String> studentsActual = history.listRegressions();
